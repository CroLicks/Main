...
import { SUPPORT_ONLY_FON, SUPPORT_ONLY_GOERLI } from 'config/constants/supportChains'
...
export const NetworkModal = ({ pageSupportedChains = SUPPORT_ONLY_GOERLI }: { pageSupportedChains?: number[] }) => {
