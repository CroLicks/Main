...
import { bscTokens, bscTestnetTokens, fonTokens, croTokens, USDC, USDT, BUSD } from '@pancakeswap/tokens'
...
export const ROUTER_ADDRESS: ChainMap<string> = {
  ...
  [ChainId.GOERLI]: '0xe40Cd9f5d71fF15F9794cF125b21167dc04d26a1',
  [ChainId.BSC]: '0x10ED43C718714eb63d5aA57B78B54704E256024E',
  [ChainId.BSC_TESTNET]: '0xD99D1c33F9fC3444f8101754aBC46c52416550D1',
  [ChainId.FON]: '0xaea18639130f9DAa0f2f82f9E133eC5CaD9023B8',
  [ChainId.CRO]: '0x145677FC4d9b8F19B5D56d1820c48e0443049a30',
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.CRO]: [croTokens.wcro, croTokens.usdt, croTokens.cro],
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.FON]: [
    fonTokens.fon,
    fonTokens.usdt,
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.BSC_TESTNET]: [bscTestnetTokens.wbnb, bscTestnetTokens.cake, bscTestnetTokens.busd],
  [ChainId.CRO]: [croTokens.wcro, croTokens.usdt],
  [ChainId.FON]: [
    fonTokens.fon,
    fonTokens.usdt,
    fonTokens.wfon,
